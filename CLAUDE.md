...
- `operations.extra_hour` y `extra_model_real_hour`/`extra_model_sim_hour` son **person-centric** (sin `escuadrilla_fk`); no se ven afectados por el filtro por escuadrilla.
