...
//   - personkeyed  → operan sobre un person_sk concreto que el caller YA validó
//     contra la escuadrilla de la sesión. Hoy las tres exentas (PersonFullName,
//     PersonHasOverlapAbsence, PersonHasOverlapComision) se llaman solo desde
//     comisiones.BulkInsertPeople, después de que PersonsInEscuadrilla rechace
//     el lote si algún person_sk es de otra escuadrilla. Si añades un caller
//     nuevo, o replica esa validación o mete el filtro de escuadrilla en la
//     query (como se hizo con ListPersonComisionesByType* y ListPersonRancheria,
//     que salieron de esta lista).
...
var exemptBaseline = map[string]string{
	...
	"LookupMedicalExamPlaces":        "catalog",
	"LookupMedicalExamResults":       "catalog",
	"AddMedicalExamPlace":            "catalog",
