...
export const queryKeys = {
    ...
    lookups: {
        ...
        capbaCatalog: (escuadrillaId: number) => ['lookups', escuadrillaId, 'capbaCatalog'] as const,
        escuadrillaCapbas: (escuadrillaId: number) => ['lookups', escuadrillaId, 'escuadrillaCapbas'] as const,
