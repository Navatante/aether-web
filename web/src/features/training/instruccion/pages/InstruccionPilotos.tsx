...
export default function InstruccionPilotos() {
    const instruccionArgs = { roles: 'Piloto', planes: 'Instrucción 1 Piloto,Instrucción 2 Piloto' };
    ...
    const { data, isLoading, error: queryError, refetch } = useApiQuery<PapeletasPersonasData>(
        ...
        queryKeys.training.instruccion.pilotos(escId ?? 0, instruccionArgs),
    );
                ...
                <div className="w-full mx-auto flex flex-col flex-1 min-h-0">
                    ...
                    <div className="flex-shrink-0 sticky top-0 z-20 bg-inherit pb-4">
                        <div className="mb-8 text-center">
                            <GradientTitle>Instrucción de Pilotos</GradientTitle>
                        </div>
