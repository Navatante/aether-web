...
export default function AdiestramientoDotaciones() {
    const adiestramientoArgs = { roles: 'Dotación,Dotación/Nadador', bloques: 'Vuelo' };
    ...
    const { data, isLoading, error: queryError, refetch } = useApiQuery<PapeletasPersonasData>(
        ...
        queryKeys.training.adiestramiento.dotaciones(escId ?? 0, adiestramientoArgs),
    );
                ...
                <div className="w-full mx-auto flex flex-col flex-1 min-h-0">
                    ...
                    <div className="flex-shrink-0 sticky top-0 z-20 bg-inherit pb-4">
                        <div className="mb-8 text-center">
                            <GradientTitle>Adiestramiento de Dotaciones</GradientTitle>
                        </div>
