...
interface WtHoursChartProps {
    data: WtTripulanteData[]
}

/**
 * Gráfico de líneas de horas de vuelo en Winch Trim: una única línea por
 * tripulante. Recibe `data` por props (sin fetching).
 */
export default function WtHoursChart({ data }: WtHoursChartProps) {
    return (
                ...
                >
                    ...
                    <ChartTooltip
                        ...
                        content={({ active, payload }) => {
                            ...
                            const d = payload[0].payload as WtTripulanteData;
                    ...
                    <Line
                        type="linear"
                        dataKey="wt_hour_qty"
                        stroke="var(--color-wt_hour_qty)"
                        strokeWidth={2}
                        dot={{ fill: "var(--color-wt_hour_qty)", r: 3, strokeWidth: 0 }}
                        connectNulls
                    />
                </LineChart>
            </ChartContainer>
