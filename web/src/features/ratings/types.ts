...
/**
 * Estado y acciones retornadas por useRatings hook.
 */
export interface UseRatingsReturn<TData> {
    // Estado de datos
    data: TData | null;
    pilotCertifications: CertificationData;
    crewCertifications: CertificationData;
    ...
    currentCertifications: CertificationData;
    filteredPersonnel: string[];
    ...
    addCertification: (personKey: string, ratingId: number, date: string) => Promise<boolean>;
    deleteCertification: (personKey: string, ratingId: number) => Promise<boolean>;
}
